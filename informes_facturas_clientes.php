                            ...
                            <tr id="pend_<?= (int)$fc['id'] ?>">
                                ...
                                <td>
                                    <?php if (!empty($fc['archivo_path'])): ?>
                                        <a href="ver_factura_cliente.php?id=<?= (int)$fc['id'] ?>&back=informes_facturas_clientes&open=pend&focus=pend_<?= (int)$fc['id'] ?>">
                                            Ver imagen
                                        </a>
                                    <?php else: ?>
                                        —
                    ...
                    <table class="tabla">
                        ...
                        <?php foreach ($pag as $fc): ?>
                            <tr id="pag_<?= (int)$fc['id'] ?>">
                                ...
                                <td>
                                    <?php if (!empty($fc['archivo_path'])): ?>
                                        <a href="ver_factura_cliente.php?id=<?= (int)$fc['id'] ?>&back=informes_facturas_clientes&open=pag&focus=pag_<?= (int)$fc['id'] ?>">
                                            Ver imagen
                                        </a>
                                    <?php else: ?>
                                        —
