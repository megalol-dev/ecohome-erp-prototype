...
En la carpeta `/docs` se incluye documentación con:
...
#### `app/pages/`
Agrupa las páginas por **módulos funcionales**, facilitando el mantenimiento y la escalabilidad.
