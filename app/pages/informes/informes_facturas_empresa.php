                    ...
                    <table class="tabla">
                        ...
                        <?php foreach ($pend as $f): ?>
                            <tr id="pend_<?= (int)$f['id'] ?>">
                                ...
                                <td>
                                    <a href="../pedidos/pedido_ver.php?id=<?= (int)$f['pedido_id'] ?>&back=informes_facturas_empresa&open=pend&focus=pend_<?= (int)$f['id'] ?>">Ver pedido</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    ...
                    <table class="tabla">
                        ...
                        <?php foreach ($pag as $f): ?>
                            <tr id="pag_<?= (int)$f['id'] ?>">
                                ...
                                <td><?= number_format((float)$f['total'], 2) ?> €</td>
                                <td>
                                    <a href="../pedidos/pedido_ver.php?id=<?= (int)$f['pedido_id'] ?>&back=informes_facturas_empresa&open=pag&focus=pag_<?= (int)$f['id'] ?>">
                                    Ver pedido</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
